...
import Cat from "../img/sdf.png";
import img from "../img/23743.jpg";
import ne from "../img/new.jpg";
import rr from "../img/rrrr.jpg";
import sa from "../img/saf.jpg";
import anastase from "../img/anastase.jpg";
import bhdf from "../img/bhdf.jpg";
    ...
    <div>
        ...
        <div className="h-[600px] relative">
          ...
          <div className="flex absolute transform -translate-x-0 translate-y-0 top-8 ">
            <h1 className="text-white text-4xl ml-[600px]   font-serif">START</h1>
            <h1 className="text-white text-4xl  ml-4 font-serif">BULIDE</h1>
          ...
          <div className="flex absolute transform -translate-x-0 translate-y-0 top-20 ">
            <h1 className="text-pink-700 text-4xl ml-[450px]   font-serif">START</h1>
            <h1 className="text-pink-700 text-4xl  ml-4 font-serif">BULIDE</h1>
            <h1 className="text-pink-700 text-4xl  ml-4 font-serif">BULIDE</h1>
            <h1 className="text-pink-700 text-4xl  ml-4 font-serif">BULIDE</h1>
         ...
         <div className="flex ml-[350px] gap-8 ">
          ...
          <img src={img} alt="" className="w-96 rounded-3xl  border border-x-white " />
          <div className=" w-10 mt-4">
          <h1 className="mt-4 text-2xl ml-5 whitespace-nowrap font-serif text-white mb-3">Basic youga</h1>
            <h1 className=" w-48 ml-5 text-white break-words ">dfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdffddddddddddddddddd</h1>
        ...
        <div className="h-[600px] relative">
          ...
          <div className=" absolute transform -translate-x-0 translate-y-0  top-40 " >
           <h1 className="text-3xl text-blue-700 font-serif ml-10">why Join Us </h1>
           <h1 className="text-md text-white font-normal ml-10 max-w-80 break-words"> UddfdfdfdfdfdfdfdfdfdddddffdUddfdfdfdfdfdfdfdfdfdddddffd</h1>
          ...
          <div className=" absolute transform -translate-x-0 translate-y-0  top-[450px] " >
           <h1 className="text-3xl text-blue-700 font-serif ml-10">why Join Us </h1>
           <h1 className="text-md text-white font-normal ml-10 max-w-80 break-words"> UddfdfdfdfdfdfdfdfdfdddddffdUddfdfdfdfdfdfdfdfdfdddddffd</h1>
